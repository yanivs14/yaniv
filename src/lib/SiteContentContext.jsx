...
const DEFAULT_CONTENT = {
  ...
  innerCircle: {
    ...
    description: "The Inner Circle is our most premium and highest-priced plan.",
    paragraph1: "Unlike our other programs, this is a highly personalized coaching experience tailored to the individual — with a custom plan, weekly live feedback, ongoing adjustments, and a level of access offered only in small capacity.",
    paragraph2: "It includes everything in the Monthly / Annual membership, plus closer support to help you progress with more precision and structure.",
    paragraph3: "",
    whatYouGet: [
    ...
    ctaLabel: "Inner Circle is designed for members looking for our most personal and premium coaching experience.",
    ctaSubtext: "If you prefer self-guided access to the full Movement library, please choose the Monthly or Annual membership.",
    ctaButton: "Apply for Inner Circle →",
    ctaFootnote: "Application starts with a private consultation with our team.",
    ctaUrl: "#",
    imageUrl: "",
  },
  about: {
