...
const DEFAULT_CONTENT = {
  ...
  pricing: {
    ...
    sectionSubtitle: "Choose the membership that fits your goals. Annual offers the best value, with exclusive ongoing content and weekly support from The Movement team.",
    sectionSubtext: "Start with full access to The Movement, or go deeper with personalized guidance and direct coaching from Roye.",
    monthlyPrice: "$35",
    monthlyDescription: "Full access to The Movement with the flexibility to pay month to month.",
    monthlyFeatures: [
    ...
    innerCircleFeatures: [
      "Everything included in Annual",
      "Personal assessment and strategy session with Roye",
      "Weekly live coaching and personalized feedback",
      "Ongoing reassessments and plan adjustments",
      "Access to a private community of committed members",
    ],
    innerCircleCta: "Apply for Inner Circle",
    innerCircleFootnote: "Limited availability · 3-month minimum commitment · Premium investment required",
  },
  finalCta: {
