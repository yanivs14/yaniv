      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <p className="font-heading text-3xl font-bold text-orange-red">8wks</p>
              <p className="font-body text-xs text-white-dim uppercase tracking-wider">to wall-free</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            {/* Benefits — numbered list style instead of cards */}
