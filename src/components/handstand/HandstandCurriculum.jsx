  ...
  return (
    <section className="py-16 lg:py-20 bg-dark-bg relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 lg:px-10">
        ...
        {/* Compact centered timeline */}
        <div className="relative">
          {/* Gradient progress line */}
          <div className="absolute left-1/2 -translate-x-1/2 top-3 bottom-3 w-px bg-gradient-to-b from-orange-red via-orange-red/30 to-dark-border" />
